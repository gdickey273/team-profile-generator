...
const createEmployee = async () => {
  ...
  const createManager = async () => {
    ...
    let manager = new Manager(name, IDIterator, email, officeNumber);
  ...
  const createIntern = async () => {
    ...
    let intern = new Intern(name, IDIterator, email, school);
  ...
  const createEngineer = async () => {
    ...
    await promptGithub();
    let engineer = new Engineer(name, IDIterator, email, github);
